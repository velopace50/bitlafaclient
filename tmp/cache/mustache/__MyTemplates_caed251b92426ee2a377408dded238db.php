...
class __MyTemplates_caed251b92426ee2a377408dded238db extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section75a45ee074653ef5f9b24be89ca041db($context, $indent, $value);
...
';
    ...
    private function section01ab325bb76bd3969658a9cd30c4fc46(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section75a45ee074653ef5f9b24be89ca041db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section01ab325bb76bd3969658a9cd30c4fc46($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';

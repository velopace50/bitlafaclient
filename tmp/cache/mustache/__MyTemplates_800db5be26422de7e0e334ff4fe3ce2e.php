...
class __MyTemplates_800db5be26422de7e0e334ff4fe3ce2e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7ddb838004fb9c4093e96c90538b5f72($context, $indent, $value);
...
';
    ...
    private function section79a29ba031b48df05ad45806ba15c700(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function section7ddb838004fb9c4093e96c90538b5f72(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section79a29ba031b48df05ad45806ba15c700($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';

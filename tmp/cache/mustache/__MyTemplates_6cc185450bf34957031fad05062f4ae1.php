...
class __MyTemplates_6cc185450bf34957031fad05062f4ae1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5fae720682b4d65ec6c5854763e45c4a($context, $indent, $value);
...
';
    ...
    private function sectionE3b119524f333c46b47a757389bba016(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap amount">
                                                    <input type="text" id="amount" name="amount" value={{market}} class="form-control form-control-lg form-control-outlined"  autocomplete="off" required>
...
';
    ...
    private function section5fae720682b4d65ec6c5854763e45c4a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->sectionE3b119524f333c46b47a757389bba016($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';

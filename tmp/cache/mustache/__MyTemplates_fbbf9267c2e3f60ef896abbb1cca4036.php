...
class __MyTemplates_fbbf9267c2e3f60ef896abbb1cca4036 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDd9674840d24db5e16da6e45a1ba5b2d($context, $indent, $value);
...
';
    ...
    private function section530c55a0101b656026ef63e934cc7c0a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap amount">
                                                    <input type="text" id="amount" name="amount" value="{{#trade}}{{market}}{{/trade}}" class="form-control form-control-lg form-control-outlined"  autocomplete="off" required>
...
';
                $buffer .= $indent . '                                                        <option value="Withdrawn">Withdrawn</option>
';
                $buffer .= $indent . '                                                        <option value="Withdrawal Pending">Withdrawal Pending</option>
';
...
';
                $buffer .= $indent . '                                                    <input type="text" id="amount" name="amount" value="';
                // 'trade' section
                $value = $context->find('trade');
                $buffer .= $this->sectionB758274be5ece8cea35deec2d91ce8b6($context, $indent, $value);
                $buffer .= '" class="form-control form-control-lg form-control-outlined"  autocomplete="off" required>
';
...
';
    ...
    private function sectionDd9674840d24db5e16da6e45a1ba5b2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
$(document).ready(function() {
    ...
    $(\'#tradeType\').change(function(){
		...
		if(tradeType ==\'Withdrawal Pending\' || tradeType == \'Withdrawn\' || tradeType ==\'deposit\' || tradeType ==\'bonusDeposit\'){
            $(\'.tradeNumber\').hide(); 
            $(\'.profit\').hide(); 
            $(\'.market\').hide();
            $(\'.winlossTrade\').hide();
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section530c55a0101b656026ef63e934cc7c0a($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '		if(tradeType ==\'Withdrawal Pending\' || tradeType == \'Withdrawn\' || tradeType ==\'deposit\' || tradeType ==\'bonusDeposit\'){
';

...
class __MyTemplates_0702e6ffb6b5d85d87805f7610c49fe3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCad2adea84b6c339fe1f40ce34116ec9($context, $indent, $value);
...
';
    ...
    private function sectionE692e2dbbcf99ccf7cfafef4671ec2b6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
    ...
    private function sectionCad2adea84b6c339fe1f40ce34116ec9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->sectionE692e2dbbcf99ccf7cfafef4671ec2b6($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';

...
class __MyTemplates_6283db00f7b8e3fa766c974df7235a0c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section74eca8075ebb5213b8e03b5e447e9678($context, $indent, $value);
...
';
    ...
    private function section4eda979557cfc14fcaebcc1a0a0e4854(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '                                                        <option value="withdrawal">Withdrawn</option>
';
...
';
    ...
    private function section74eca8075ebb5213b8e03b5e447e9678(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section4eda979557cfc14fcaebcc1a0a0e4854($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';

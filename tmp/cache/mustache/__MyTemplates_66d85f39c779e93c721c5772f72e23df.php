...
class __MyTemplates_66d85f39c779e93c721c5772f72e23df extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB3de22add7d7ac292aab48e5103f6498($context, $indent, $value);
...
';
    ...
    private function section5988103cb0bfdf2baac4541d59836afd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <select id="tradeType" name="tradeType" class="form-select form-control form-control-lg" data-ui="lg" required>
                                                        ...
                                                        <option value="withdrawal">Withdrawal Pending</option>
...
';
                $buffer .= $indent . '                                                        <option value="withdrawal">Withdrawal Pending</option>
';
...
';
    ...
    private function sectionB3de22add7d7ac292aab48e5103f6498(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
...
$(document).ready(function() {
    ...
    $(\'#tradeType\').change(function(){
		...
		if(tradeType ==\'withdrawal\' || tradeType == \'Withdrawn\' || tradeType ==\'deposit\' || tradeType ==\'bonusDeposit\'){
            $(\'.tradeNumber\').hide(); 
            $(\'.profit\').hide(); 
            $(\'.market\').hide();
            $(\'.winlossTrade\').hide();
...
';
                // 'isTrade' section
                $value = $context->find('isTrade');
                $buffer .= $this->section5988103cb0bfdf2baac4541d59836afd($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                    </div>
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '		if(tradeType ==\'withdrawal\' || tradeType == \'Withdrawn\' || tradeType ==\'deposit\' || tradeType ==\'bonusDeposit\'){
';
